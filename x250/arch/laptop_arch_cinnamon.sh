...
cd /tmp/aurbuilder
rm -r *
for package in "dxvk-bin" "aic94xx-firmware" "wd719x-firmware" "mpv-mpris" "lbry-app-bin" "jdownloader2" "visual-studio-code-bin" "qt6gtk2" "pfetch" "youtube-dlp-bin" "yt-dlp-drop-in" "insomnia-bin" "minecraft-launcher" "gitkraken" "google-chrome"
do
