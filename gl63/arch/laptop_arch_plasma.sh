...
cd /tmp/aurbuilder
rm -r *
for package in "dxvk-bin" "aic94xx-firmware" "wd719x-firmware" "mpv-mpris" "lbry-app-bin" "jdownloader2" "visual-studio-code-bin" "android-studio" "youtube-dlp-bin" "yt-dlp-drop-in" "insomnia-bin" "minecraft-launcher" "gitkraken" "vivaldi-widevine"
do
...
sudo -u link yay -S --noconfirm protontricks eclipse-jee-bin mednafen snapd xampp
