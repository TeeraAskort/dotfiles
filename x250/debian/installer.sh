...
if [ "$1" = "gnome" ] || [ "$1" = "kde" ] || [ "$1" = "plasma" ]; then
	...
	apt install -y mpv flatpak mednafen mednaffe vim papirus-icon-theme zsh zsh-syntax-highlighting zsh-autosuggestions firmware-linux steam telegram-desktop neovim fonts-noto-cjk openjdk-11-jdk thermald intel-microcode gamemode hyphen-en-us mythes-en-us sqlitebrowser net-tools tlp wget apt-transport-https gnupg cmake nodejs npm chromium code libpam-u2f pamu2fcfg libfido2-1 hunspell-es hunspell-en-us dolphin-emu libreoffice firefox-esr gimp w64codecs gstreamer1.0-plugins-bad gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-ugly gstreamer1.0-pulseaudio gstreamer1.0-qt5 gstreamer1.0-vaapi gstreamer1.0-libav youtube-dl earlyoom apparmor apparmor-utils apparmor-profiles-extra apparmor-profiles apparmor-notify cups hp-ppd hplip firewalld python-neovim xserver-xorg-input-libinput bluetooth plymouth plymouth-themes vim-nox python3-dev build-essential
