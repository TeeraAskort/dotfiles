...
# Installing drivers 
pacman -S --noconfirm lib32-mesa vulkan-intel lib32-vulkan-intel vulkan-icd-loader lib32-vulkan-icd-loader liva-intel-driver intel-media-driver xf86-video-intel
