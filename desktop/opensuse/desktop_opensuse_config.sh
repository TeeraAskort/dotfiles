...
if [ "$1" == "gnome" ] || [ "$1" == "kde" ] || [ "$1" == "plasma" ] || [ "$1" == "cinnamon" ]; then
	...
	if [ "$1" == "kde" ] || [ "$1" == "plasma" ]; then
		...
		# Removing unwanted DE specific applications
		zypper rm -y blueman #TODO

		# Installing DE specific applications
		zypper in -y xcape playerctl transmission-gtk gvfs gvfs-backends gvfs-backend-samba gvfs-fuse ffmpegthumbnailer webp-pixbuf-loader tilix gnome-mahjongg adwaita-qt5 QGnomePlatform aisleriot libgepub-0_6-0 libgsf-1-114 libopenraw1 lightdm-slick-greeter brasero pavucontrol xarchiver blueberry evince gnome-keyring-pam gnome-keyring
