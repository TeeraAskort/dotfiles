...
flatpak install -y flathub org.jdownloader.JDownloader org.gtk.Gtk3theme.Adwaita-dark sh.ppy.osu com.discordapp.Discord com.heroicgameslauncher.hgl org.telegram.desktop
