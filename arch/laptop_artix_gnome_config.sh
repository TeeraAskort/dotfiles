...
sed -i '/\[lib32\]/{n;s/^#//g}' /etc/pacman.conf
pacman -Syu

# Installing drivers 
pacman -S nvidia nvidia-utils lib32-nvidia-utils nvidia-settings vulkan-icd-loader lib32-vulkan-icd-loader nvidia-prime lib32-mesa vulkan-intel lib32-vulkan-intel xf86-input-wacom xf86-input-libinput
...
pacman -Rnsc gnome-music epiphany totem 
