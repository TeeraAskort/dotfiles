...
cd /tmp/aurbuilder
rm -r *
for package in "dxvk-bin" "aic94xx-firmware" "wd719x-firmware" "mpv-mpris" "lbry-app-bin" "jdownloader2" "visual-studio-code-bin" "android-studio"  "pfetch" "youtube-dlp-bin" "yt-dlp-drop-in" "postman-bin" "minecraft-launcher" "gitkraken" "vivaldi-widevine"
do
