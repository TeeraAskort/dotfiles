...
sudo -u aurbuilder yay -S --noconfirm dxvk-bin jdownloader2 visual-studio-code-bin pfetch postman-bin minigalaxy virtualbox-ext-oracle minecraft-launcher # touchegg
