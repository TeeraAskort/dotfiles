...
# Install XFCE
pacman -S --noconfirm  xfce4 xfce4-goodies blueberry pavucontrol playerctl gvfs ffmpegthumbnailer network-manager-applet lightdm ttf-droid ttf-dejavu gtk-engine-murrine

# Installing lightdm-slick-greeter and lightdm-settings
sudo -u aurbuilder yay -S lightdm-slick-greeter lightdm-settings plymouth
...
# Installing hexagon_2 plymouth theme
...
sudo -u aurbuilder yay -S dxvk-bin aic94xx-firmware wd719x-firmware nerd-fonts-fantasque-sans-mono minecraft-launcher android-studio xampp qt5-styleplugins key-mapper-git mpv-mpris
