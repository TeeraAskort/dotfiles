...
in
{
  ...
  environment.systemPackages = with pkgs; [
    ...
    obs-studio libfido2 pfetch desmume
    ...
    adwaita-qt 
    gnomeExtensions.gsconnect gnomeExtensions.appindicator gnomeExtensions.espresso gnomeExtensions.lock-keys
    firefox
  ];
