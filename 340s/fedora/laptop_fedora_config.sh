...
dnf in -y "https://github.com/mongodb-js/compass/releases/download/v1.32.1/mongodb-compass-1.32.1.x86_64.rpm"
...
flatpak install -y flathub org.jdownloader.JDownloader org.gtk.Gtk3theme.Adwaita-dark com.mojang.Minecraft com.getpostman.Postman sh.ppy.osu 
