...
sudo -u aurbuilder yay -S --noconfirm dxvk-bin aic94xx-firmware wd719x-firmware mpv-mpris jdownloader2 visual-studio-code-bin pfetch postman-bin gdlauncher-bin minigalaxy virtualbox-ext-oracle gitkraken # touchegg
