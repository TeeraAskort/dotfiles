...
in
{
  ...
  environment.systemPackages = with pkgs; [
    ...
    tilix firefox mpv rhythmbox noto-fonts 
    nerdfonts noto-fonts-cjk noto-fonts-emoji plata-theme papirus-icon-theme transmission-gtk
    gnome3.aisleriot nvidia-offload discord libreoffice-fresh
    ...
    chromium ffmpegthumbnailer gimp gnome3.gnome-mahjongg
...
#    };
  ...
  # Enabling cinnamon default apps
