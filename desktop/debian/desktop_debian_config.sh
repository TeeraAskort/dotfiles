...
if [ "$1" == "gnome" ] || [ "$1" == "kde" ] || [ "$1" == "plasma" ] || [ "$1" == "xfce" ] || [ "$1" == "cinnamon" ]; then
	...
	flatpak install -y flathub org.jdownloader.JDownloader org.nicotine_plus.Nicotine com.obsproject.Studio sh.ppy.osu com.heroicgameslauncher.hgl
