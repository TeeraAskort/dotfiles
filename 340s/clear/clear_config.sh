...
swupd bundle-add lutris games vim neovim mpv zsh java-basic earlyoom flatpak nodejs-basic kernel-native-dkms wine zip storage-utils unzip docker-compose yarn desktop-apps
