...
sudo -u aurbuilder yay -S --noconfirm dxvk-bin mpv-mpris jdownloader2 visual-studio-code-bin pfetch postman-bin minigalaxy virtualbox-ext-oracle gitkraken minecraft-launcher # touchegg
