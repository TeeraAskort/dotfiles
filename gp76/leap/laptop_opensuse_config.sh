...
if [ "$1" == "gnome" ] || [ "$1" == "kde" ] || [ "$1" == "plasma" ] || [ "$1" == "cinnamon" ] || [ "$1" == "xfce" ]; then
	...
	# Installing repos
	zypper ar http://download.opensuse.org/repositories/games/15.4/games.repo
	zypper ar http://download.opensuse.org/repositories/Emulators:/Wine/15.4/Emulators:Wine.repo
	zypper ar http://download.opensuse.org/repositories/shells:/zsh-users:/zsh-syntax-highlighting/15.4/shells:zsh-users:zsh-syntax-highlighting.repo
	zypper addrepo https://download.opensuse.org/repositories/shells:zsh-users:zsh-autosuggestions/15.4/shells:zsh-users:zsh-autosuggestions.repo
	...
	zypper ar https://download.opensuse.org/repositories/Emulators/15.4/Emulators.repo
	...
	systemctl enable thermald earlyoom tlp
	...
	flatpak install -y flathub org.jdownloader.JDownloader org.telegram.desktop sh.ppy.osu com.github.AmatCoder.mednaffe org.DolphinEmu.dolphin-emu com.heroicgameslauncher.hgl net.pcsx2.PCSX2
