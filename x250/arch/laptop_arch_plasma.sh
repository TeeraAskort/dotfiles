...
cd /tmp/aurbuilder
rm -r *
for package in "dxvk-bin" "aic94xx-firmware" "wd719x-firmware" "mpv-mpris" "lbry-app-bin" "jdownloader2" "visual-studio-code-bin" "pfetch" "youtube-dlp-bin" "yt-dlp-drop-in" "postman-bin" "sequeler" "minecraft-launcher"
do
...
until sudo -u link yay -S android-studio protontricks eclipse-jee-bin --noconfirm
do
	echo "retrying"
done
